...
def main(mainpath, response_headers):
	...
	root_event_src_folder = f"src/main/java/net/{org_name.lower()}/{repo_name.lower()}/event"
	retro_root_event_src_folder = f"src/main/java/net/minecraftforge/event"
	...
	# NeoForge start at branch 1.20.1.
	index = branches.index('1.20.1')
